/* $Id: seas.c 4020 2008-04-16 15:43:25Z eliasbaixas $
 *
...
static int w_as_relay_t(struct sip_msg *msg, char *entry, char *foo)
{
   ...
   struct cell *mycel;
   struct as_entry *as;
#define SEAS_YOURCALL "Your call is important to us"
#define SEAS_YOURCALL_L (sizeof(SEAS_YOURCALL)-1)
#define SEAS_ERROR_MSG "Server Internal Error!"
#define SEAS_ERROR_MSG_L (sizeof(SEAS_ERROR_MSG)-1)
   static str msg100={SEAS_YOURCALL ,SEAS_YOURCALL_L};
   static str msg500={SEAS_ERROR_MSG,SEAS_ERROR_MSG_L};
